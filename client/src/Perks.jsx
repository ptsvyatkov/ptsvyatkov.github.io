...
export default function Perks({ place, selected, onChange }) {
    ...
    return (
        <>
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                ...
                <span>{t('form_place_features_wifi')}</span>
            </label>
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                ...
                <span>{t('form_place_features_parking_spot')}</span>
            </label>
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                ...
                <span>{t('form_place_features_TV')}</span>
            </label>
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                ...
                <span>{t('form_place_features_radio')}</span>
            </label>
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
